...
export const fallbackGallery = [
  {
    ...
    text: "Implantação de reservatórios, guarda-corpo, acessos, interligações e preparação para teste e entrega do sistema.",
    image:
  ...
  },
  {
    ...
    text: "Frentes com adequações, travessias, soldagem e organização do sistema para continuidade operacional e partida assistida.",
    image:
